...
from .forms import CreateContestForm, CreateProblem, UploadCodeForm, ReturnJudgeResultForm, CreateContestTemplateForm
...
def edit(request, contest_id):
    ...
    return render(request, 'contests/edit_contest.html', {'form': form, 'problem_form': problem_form, 'problems_set': problems_set, 'contest_id': contest_id})
